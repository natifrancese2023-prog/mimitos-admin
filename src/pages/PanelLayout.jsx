    ...
    <div className={`panel-layout ${sidebarAbierto ? "sidebar-open" : "sidebar-closed"}`}>
      ...
      <aside className="sidebar">
        <div className="sidebar-header">
          <span className="sidebar-logo">Vertex</span>
          <button
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/panel/venta-directa" className="nav-item">
            <span className="nav-icon">🛒</span> {/* Le cambié el ícono a un carrito para que no se repita con Gastos 😉 */}
            <span className="nav-text">Venta Directa</span>
          </NavLink>
          <NavLink to="/panel/compras-sugeridas" className="nav-item">
            <span className="nav-icon">🛒</span> {/* Le cambié el ícono a un carrito para que no se repita con Gastos 😉 */}
            <span className="nav-text">Compras Sugeridas</span>
          </NavLink>

          {/* FASE 2 -- Cuenta Corriente */}
          <NavLink to="/panel/cuenta-corriente" className="nav-item">
            <span className="nav-icon">📒</span>
            <span className="nav-text">Cuenta Corriente</span>
          </NavLink>

          {/* FASE 3 -- Caja */}
          <NavLink to="/panel/caja" className="nav-item">
            <span className="nav-icon">🗄️</span>
      ...
      <div className="panel-main">
        <header className="topbar">
          ...
          <span className="topbar-saludo">Usuario:{nombre} </span>
        </header>
