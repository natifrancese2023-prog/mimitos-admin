...
export default function Productos() {
  ...
  function validarProducto(p, variantesActuales) {
    ...
    if (!variantesActuales || variantesActuales.length === 0) {
      ...
      if (varianteInvalida)
        err.variantes =
          "Todas las variantes deben tener nombre, precio de venta mayor a 0, y stock/precio de compra no pueden ser negativos";
    }
  ...
  const handleGuardar = async () => {
    ...
    try {
      ...
      formData.append(
        "proveedores",
        JSON.stringify(productoActual.proveedores || []),
      );
                    ...
                    <td>
                      <div className="acciones">
                        ...
                        <button
                          className="btn-info"
                          onClick={() =>
                            navigate(`/panel/productos/${fila.id_producto}`, {
                              state: {
                                idProducto: fila.id_producto,
                                idVariante: fila.id_variante,
                                nombre: fila.nombre,
                                variante: fila.nombre_variante,
                              },
                            })
                          }
                          title="Ver historial"
            ...
            <div className="modal-body">
              ...
              <div className="form-grid">
                ...
                <div className="field-group">
                  ...
                  <select
                    multiple
                    value={(productoActual.proveedores || []).map(String)}
                    onChange={(e) =>
                      setProductoActual({
                        ...productoActual,
                  ...
                  <small>Podes seleccionar mas de un proveedor.</small>
                </div>
                <div className="field-group full-width">
                  ...
                  <div className="variantes-panel">
                    {variantes.length > 0 && (
                      <div
                        className="variantes-header-row"
                        style={{
                          display: "flex",
                          gap: "8px",
                          fontWeight: "bold",
                      ...
                      >
                        <span style={{ flex: 2 }}>Nombre / Talle / Color</span>
                        <span style={{ flex: 2 }}>Código de barras</span>
                        <span style={{ flex: 1 }}>Stock</span>
                        <span style={{ flex: 1 }}>P. Compra</span>
                        <span style={{ flex: 1 }}>P. Venta</span>
