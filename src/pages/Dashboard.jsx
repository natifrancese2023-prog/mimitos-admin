        ...
        {cargando ? (
          ...
          <>
            ...
            <div className="dash-grid-5">
              ...
              <div
                className={`tarjeta ${
                  datos.totales.gananciaProductos >= 0
                    ? "tarjeta-ganancia"
                    : "tarjeta-perdida"
                }`}
              >
                <div className="tarjeta-icono">🧮</div>
                <div className="tarjeta-info">
                  <span className="tarjeta-label">Ganancia por ventas</span>
                  <span className="tarjeta-valor">
                    ${datos.totales.gananciaProductos.toLocaleString()}
                  </span>
                  <span className="tarjeta-sub">Precio venta − costo</span>
                </div>
              </div>
